    ...
    try {
        if (message.content.toLowerCase() === '!wallet') {
            ...
            const embed = new EmbedBuilder()
                ...
                .setFields({ name: '\u000B', value: '\u000B' }, { name: "Starting Moni: Here You go kiddo. Use Wisely.", value: "" }, { name: "", value: `$ ${startingMoni}` }, { name: '\u000B', value: '\u000B' }, { name: "", value: `Yu Worth ALAT, but your worth is ${startingWorth}` }, { name: "", value: `Enjoy Your fAkE wAlleT :P` })
                .setColor(0x5D4E8B)
                .setTimestamp()
